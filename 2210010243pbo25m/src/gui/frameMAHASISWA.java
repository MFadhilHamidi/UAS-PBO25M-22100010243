...
String judulkolom[] = {"ID Mahasiswa", "Nama", "Status", "Telepon"};
int lebarkolom[] = {150, 300, 200, 100};
...
crudTable crud;
    public frameMAHASISWA() {
        ...
        crud = new crudTable();
        crud.settingJudulTabel(tableDVD, judulkolom);
        crud.settingLebarKolom(tableDVD, lebarkolom);
        crud.tampilTabel(tableDVD, SQL, judulkolom);
    }
